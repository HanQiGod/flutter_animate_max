...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'Flutter Animate Max Demo',
      debugShowCheckedModeBanner: false,
      home: FlutterAnimateMaxExample(),
    );
  }
}

// this is a very quick and dirty example.
class FlutterAnimateMaxExample extends StatefulWidget {
  const FlutterAnimateMaxExample({Key? key}) : super(key: key);
  ...
  @override
  State<FlutterAnimateMaxExample> createState() =>
      _FlutterAnimateMaxExampleState();
}

class _FlutterAnimateMaxExampleState extends State<FlutterAnimateMaxExample> {
  int _viewIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          for (final tab in FlutterAnimateMaxExample.tabs)
      ...
      body: DefaultTextStyle(
        ...
        child: SafeArea(
          bottom: false,
          child: FlutterAnimateMaxExample.tabs[_viewIndex].builder(context),
        ),
      ),
    );
  }
